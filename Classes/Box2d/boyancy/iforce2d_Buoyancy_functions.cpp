...
b2Vec2 b2dHelper::ComputeCentroid(std::vector<b2Vec2> vs, float& area) {
...
bool b2dHelper::inside(b2Vec2 cp1, b2Vec2 cp2, b2Vec2 p) {
	return ( cp2.x - cp1.x )*( p.y - cp1.y ) > ( cp2.y - cp1.y )*( p.x - cp1.x );
}

b2Vec2 b2dHelper::intersection(b2Vec2 cp1, b2Vec2 cp2, b2Vec2 s, b2Vec2 e) {
...
bool b2dHelper::findIntersectionOfFixtures(b2Fixture* fA, b2Fixture* fB, std::vector<b2Vec2>& outputVertices) {
